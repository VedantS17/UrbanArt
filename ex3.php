   ...
   <div class="container">
     <div class="row justify-content-between gy-5">
       ...
       <div class="col-lg-5 order-1 order-lg-2 text-center text-lg-start">
         <img src="assests1/img/download7.jpg" class="img-fluid" alt="" data-aos="zoom-out" data-aos-delay="300" style="width: 100%; height: auto">
       </div>
     </div>
   </div>
    ...
    <section>
      <div class="container" data-aos="fade-up">
        <div class="row">
          ...
          <div class="col-lg-4 text-center mb-5">
            <img src="assests1/img/download1.jpg"" class="img-fluid rounded-circle w-100 mb-4">
            <h4>Urban Rhythms</h4>
            <span class="d-block mb-3 text-uppercase text">
          ...
          <div class="col-lg-4 text-center mb-5">
            <img src="assests1/img/download13.jpg" alt="" class="img-fluid rounded-circle w-100 mb-4">
          ...
          <div class="col-lg-4 text-center mb-5">
            <img src="assests1/img/download11.jpg" alt="" class="img-fluid rounded-circle w-100 mb-4">
