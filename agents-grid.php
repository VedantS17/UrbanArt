...
<body>
  ...
  <main id="main">
        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single">Featured Artists</h1>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- ======= Agents Grid ======= -->
    <section class="agents-grid grid" style="padding-bottom: 0px;">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="image-box mb-3">
              ...
              <div class="overlay-text">
                  <h4><a href="category1_sketches.php" style="color:white">Sketch Artists</a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="image-box">
              ...
              <div class="overlay-text">
                  <h4><a href="category1_portraits.php" style="color:white">Portrait Artists</a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="image-box">
              ...
              <div class="overlay-text">
                  <h4><a href="category1_sculpture.php" style="color:white">Sculpture Artists</a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="image-box">
              ...
              <div class="overlay-text">
                  <h4><a href="category1_canvas.php" style="color:white">Canvas Artists</a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="image-box">
              ...
              <div class="overlay-text">
                  <h4><a href="category1_watercolor.php" style="color:white">Watercolor Artists</a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="image-box">
              ...
              <div class="overlay-text">
                  <h4><a href="category1_digital.php" style="color:white">Digital Art Artists</a></h4>
