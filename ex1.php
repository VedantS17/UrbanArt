     ...
     <div class="row justify-content-between gy-5">
       <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center align-items-center align-items-lg-start text-center text-lg-start">
         ...
         <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
           ...
           <a href="https://youtu.be/LCQG5JQPOoc?si=UWd_emSBtGVTp4wa" class="glightbox btn-watch-video d-flex align-items-center"><i class="bi bi-play-circle"></i><span>Watch Video</span></a>
         </div>
       </div>
       <div class="col-lg-5 order-1 order-lg-2 text-center text-lg-start">
         <img src="assests1/img/download1.jpg" class="img-fluid" alt="" data-aos="zoom-out" data-aos-delay="300" style="width: 100%; height: auto">
       </div>
     </div>
   </div>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row">
          ...
          <div class="col-lg-4 text-center mb-5">
            <img src="assests1/img/download2.jpg" alt="" class="img-fluid rounded-circle w-100 mb-4">
          ...
          <div class="col-lg-4 text-center mb-5">
            <img src="assests1/img/download1.jpg" alt="" class="img-fluid rounded-circle w-100 mb-4">
          ...
          <div class="col-lg-4 text-center mb-5">
            <img src="assests1/img/download3.jpg" alt="" class="img-fluid rounded-circle w-100 mb-4">
            <h4>Urban Rhythms</h4>
            <span class="d-block mb-3 text-uppercase text">
          ...
          <div class="col-lg-4 text-center mb-5">
            <img src="assests1/img/download4.jpg" alt="" class="img-fluid rounded-circle w-100 mb-4">
