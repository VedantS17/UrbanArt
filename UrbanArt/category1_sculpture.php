...
<li>
  <form action="manage_cart.php" method="POST">
    <div  class="product-card">
      ...
      <figure class="card-banner">
      <img src="./assets/img_sculpture/4.jpg" width="189" height="189" loading="lazy" alt="The Circle">
      </figure>
      ...
      <div class="price-wrapper">
        <del class="del">Rs.5600</del>
        <data class="price1">Rs.5000</data>
      </div>

      <button type="submit" name="Add_To_Cart" class="btn btn-primary">Add to Cart</button>
      <input type="hidden" name="Item_Name" value="The Circle">
...
<li>
  <form action="manage_cart.php" method="POST">
    <div class="product-card">
      ...
      <figure class="card-banner">
      <img src="./assets/img_sculpture/5.jpg" width="189" height="189" loading="lazy" alt="The Hand">
      </figure>
      ...
      <h3 class="h4 card-title">
        <a href="single_product.php">The Hand</a>
      </h3>
...
<li> 
  <form action="manage_cart.php" method="POST">
    <div class="product-card">
      ...
      <figure class="card-banner">
      <img src="./assets/img_sculpture/6.jpg" width="189" height="189" loading="lazy" alt="Horse">
      </figure>
      ...
      <h3 class="h4 card-title">
        <a href="single_product.php">Horse</a>
      </h3>
      ...
      <button type="submit" name="Add_To_Cart" class="btn btn-primary">Add to Cart</button>
      <input type="hidden" name="Item_Name" value="Horse">
...
<li>
  <form action="manage_cart.php" method="POST">
    <div class="product-card">
      ...
      <figure class="card-banner">
      <img src="./assets/img_sculpture/7.jpg" width="189" height="189" loading="lazy" alt="enigma of beauty">
      </figure>
      ...
      <h3 class="h4 card-title">
        <a href="single_product.php">Enigma of beauty</a>
      </h3>
      ...
      <button type="submit" name="Add_To_Cart" class="btn btn-primary">Add to Cart</button>
      <input type="hidden" name="Item_Name" value="Enigma of beauty">
...
<li>
  <form action="manage_cart.php" method="POST">
    <div class="product-card">
      ...
      <figure class="card-banner">
      <img src="./assets/img_sculpture/8.jpg" width="189" height="189" loading="lazy" alt="African Elephant">
      </figure>
      ...
      <h3 class="h4 card-title">
        <a href="single_product.php">African Elephant</a>
      </h3>

      <div class="price-wrapper">
        <del class="del">Rs.6000</del>
        <data class="price1">Rs.5850</data>
      </div>

      <button type="submit" name="Add_To_Cart" class="btn btn-primary">Add to Cart</button>
      <input type="hidden" name="Item_Name" value="African Elephant">
      <input type="hidden" name="Price" value="5850">
    </div>
  </form>
</li>
</ul>
