  ...
  <form action="manage_cart.php" method="POST">
    <div  class="product-card">
      ...
      <figure class="card-banner">
        <img src="./assets/img_sketches/1.jpeg" width="189" height="189" loading="lazy" alt="MSD">
      </figure>
      ...
      <h3 class="h4 card-title">
        <a href="single_product.php">M S Dhoni</a>
      </h3>
      ...
      <input type="hidden" name="Item_Name" value="M S Dhoni">
...
<li>
  <form action="manage_cart.php" method="POST">
    <div  class="product-card">
      ...
      <figure class="card-banner">
      <img src="./assets/img_sketches/2.jpeg" width="189" height="189" loading="lazy" alt="Emma Watson">
      </figure>
      ...
      <h3 class="h4 card-title">
        <a href="single_product.php">Emma Watson</a>
      </h3>

      <div class="price-wrapper">
        <del class="del">Rs.1500</del>
        <data class="price1">Rs.1200</data>
      </div>

      <button type="submit" name="Add_To_Cart" class="btn btn-primary">Add to Cart</button>
      <input type="hidden" name="Item_Name" value="Emma Watson">
...
<li>
  <form action="manage_cart.php" method="POST">
    <div  class="product-card">
      <figure class="card-banner">
      <img src="./assets/img_sketches/3.jpeg" width="189" height="189" loading="lazy" alt="Messi">
      </figure>
      ...
      <h3 class="h4 card-title">
        <a href="single_product.php">Lionel Messi</a>
      </h3>

      <div class="price-wrapper">
        <del class="del">Rs.2500</del>
        <data class="price1">Rs.2200</data>
      </div>

      <button type="submit" name="Add_To_Cart" class="btn btn-primary">Add to Cart</button>
      <input type="hidden" name="Item_Name" value="Lionel Messi">
...
<li>
  <form action="manage_cart.php" method="POST">
    <div  class="product-card">
      ...
      <figure class="card-banner">
      <img src="./assets/img_sketches/4.jpeg" width="189" height="189" loading="lazy" alt="Eye">
      </figure>
      ...
      <h3 class="h4 card-title">
        <a href="single_product.php">Abstarct Eye</a>
      </h3>

      <div class="price-wrapper">
        <del class="del">Rs.1800</del>
        <data class="price1">Rs.1600</data>
      </div>

      <button type="submit" name="Add_To_Cart" class="btn btn-primary">Add to Cart</button>
      <input type="hidden" name="Item_Name" value="Abstarct Eye">
...
<li>
  <form action="manage_cart.php" method="POST">
    <div class="product-card">
      ...
      <figure class="card-banner">
      <img src="./assets/img_sketches/5.jpeg" width="189" height="189" loading="lazy" alt="Paul Walker">
      </figure>
      ...
      <h3 class="h4 card-title">
        <a href="single_product.php">Paul Walker</a>
      </h3>

      <div class="price-wrapper">
        <del class="del">Rs.2700</del>
        <data class="price1">Rs.2500</data>
      </div>

      <button type="submit" name="Add_To_Cart" class="btn btn-primary">Add to Cart</button>
      <input type="hidden" name="Item_Name" value="Paul Walker">
...
<li> 
  <form action="manage_cart.php" method="POST">
    <div class="product-card">
      ...
      <figure class="card-banner">
      <img src="./assets/img_sketches/6.jpeg" width="189" height="189" loading="lazy" alt="Olivia">
      </figure>
      ...
      <h3 class="h4 card-title">
        <a href="single_product.php">Olivia Rodrigo</a>
      </h3>
      ...
      <button type="submit" name="Add_To_Cart" class="btn btn-primary">Add to Cart</button>
      <input type="hidden" name="Item_Name" value="Olivia Rodrigo">
...
<li>
  <form action="manage_cart.php" method="POST">
    <div class="product-card">
      ...
      <figure class="card-banner">
      <img src="./assets/img_sketches/7.jpeg" width="189" height="189" loading="lazy" alt="VK">
      </figure>
      ...
      <h3 class="h4 card-title">
        <a href="single_product.php">Virat Kohli</a>
      </h3>

      <div class="price-wrapper">
        <del class="del">Rs.4000</del>
        <data class="price1">Rs.3800</data>
      </div>

      <button type="submit" name="Add_To_Cart" class="btn btn-primary">Add to Cart</button>
      <input type="hidden" name="Item_Name" value="Virat Kohli">
...
<li>
  <form action="manage_cart.php" method="POST">
    <div class="product-card">
      ...
      <figure class="card-banner">
      <img src="./assets/img_sketches/8.jpeg" width="189" height="189" loading="lazy" alt="Nancy">
      </figure>
      ...
      <h3 class="h4 card-title">
        <a href="single_product.php">Nancy</a>
      </h3>

      <div class="price-wrapper">
        <del class="del">Rs.2000</del>
        <data class="price1">Rs.1800</data>
      </div>

      <button type="submit" name="Add_To_Cart" class="btn btn-primary">Add to Cart</button>
      <input type="hidden" name="Item_Name" value="Nancy">
