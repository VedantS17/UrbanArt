...
<body>
  ...
  <form action="manage_cart.php" method="POST">
    <div class="product-card">
      ...
      <img src="./assets/img_canvas/1.jpg" width="189" height="189" loading="lazy" alt="1">
      </figure>
      ...
      <h3 class="h4 card-title">
        <a href="single_product.php">Waterfall</a>
      </h3>

      <div class="price-wrapper">
        <del class="del">Rs.3500</del>
        <data class="price1">Rs.3200</data>
      </div>

      <button type="submit" name="Add_To_Cart" class="btn btn-primary">Add to Cart</button>
      <input type="hidden" name="Item_Name" value="Waterfall">
...
<li>
  <form action="manage_cart.php" method="POST">
    <div class="product-card">
      ...
      <figure class="card-banner">
      <img src="./assets/img_canvas/2.jpg" width="189" height="189" loading="lazy" alt="Lake">
      </figure>
      ...
      <h3 class="h4 card-title">
        <a href="single_product.php">Lake</a>
      </h3>
...
<li>
  <form action="manage_cart.php" method="POST">
    <div  class="product-card">
      <figure class="card-banner">
      <img src="./assets/img_canvas/3.jpg" width="189" height="189" loading="lazy" alt="parrot">
      </figure>
      ...
      <h3 class="h4 card-title">
        <a href="single_product.php">Parrot</a>
      </h3>

      <div class="price-wrapper">
        <del class="del">Rs.4500</del>
        <data class="price1">Rs.4250</data>
      </div>
...
<li>
  <form action="manage_cart.php" method="POST">
    <div  class="product-card">
      ...
      <figure class="card-banner">
      <img src="./assets/img_canvas/4.jpg" width="189" height="189" loading="lazy" alt="Deer">
      </figure>
      ...
      <h3 class="h4 card-title">
        <a href="single_product.php">Deer</a>
      </h3>

      <div class="price-wrapper">
        <del class="del">Rs.4700</del>
        <data class="price1">Rs.4580</data>
      </div>

      <button type="submit" name="Add_To_Cart" class="btn btn-primary">Add to Cart</button>
      <input type="hidden" name="Item_Name" value="Deer">
...
<li>
  <form action="manage_cart.php" method="POST">
    <div class="product-card">
      ...
      <figure class="card-banner">
      <img src="./assets/img_canvas/5.jpg" width="189" height="189" loading="lazy" alt="Boat">
      </figure>
      ...
      <h3 class="h4 card-title">
        <a href="single_product.php">Boat</a>
      </h3>

      <div class="price-wrapper">
        <del class="del">Rs.5700</del>
        <data class="price1">Rs.5530</data>
      </div>

      <button type="submit" name="Add_To_Cart" class="btn btn-primary">Add to Cart</button>
      <input type="hidden" name="Item_Name" value="Boat">
...
<li> 
  <form action="manage_cart.php" method="POST">
    <div class="product-card">
      ...
      <figure class="card-banner">
      <img src="./assets/img_canvas/6.jpg" width="189" height="189" loading="lazy" alt="Town">
      </figure>
      ...
      <h3 class="h4 card-title">
        <a href="single_product.php">Town</a>
      </h3>
      ...
      <button type="submit" name="Add_To_Cart" class="btn btn-primary">Add to Cart</button>
      <input type="hidden" name="Item_Name" value="Town">
...
<li>
  <form action="manage_cart.php" method="POST">
    <div class="product-card">
      ...
      <figure class="card-banner">
      <img src="./assets/img_canvas/7.jpg" width="189" height="189" loading="lazy" alt="Forest">
      </figure>
      ...
      <h3 class="h4 card-title">
        <a href="single_product.php">Forest</a>
      </h3>

      <div class="price-wrapper">
        <del class="del">Rs.4250</del>
        <data class="price1">Rs.4000</data>
      </div>

      <button type="submit" name="Add_To_Cart" class="btn btn-primary">Add to Cart</button>
      <input type="hidden" name="Item_Name" value="Forest">
...
<li>
  <form action="manage_cart.php" method="POST">
    <div class="product-card">
      ...
      <figure class="card-banner">
      <img src="./assets/img_canvas/8.jpg" width="189" height="189" loading="lazy" alt="Venice">
      </figure>
      ...
      <h3 class="h4 card-title">
        <a href="single_product.php">Venice</a>
      </h3>
      ...
      <button type="submit" name="Add_To_Cart" class="btn btn-primary">Add to Cart</button>
      <input type="hidden" name="Item_Name" value="Venice">
